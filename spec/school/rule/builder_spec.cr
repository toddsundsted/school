...
Spectator.describe School::Rule::Builder do
  ...
  describe "#assert" do
    ...
    context "given a fact" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(MockFact).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockFact.new)
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::NullaryPattern(MockFact)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockFact.new)
      end
    end
    ...
    context "given a property" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(MockProperty, School::Lit.new(123)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockProperty.new(123))
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::UnaryPattern(MockProperty, Int32), School::Lit.new(123)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockProperty.new(123))
      end
    end
    ...
    context "given a property" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new(123), MockProperty).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockProperty.new(123))
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new(123), School::UnaryPattern(MockProperty, Int32)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockProperty.new(123))
      end
    end
    ...
    context "given a relationship" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(MockRelationship, School::Lit.new("abc"), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::BinaryPattern(MockRelationship, String, String), School::Lit.new("abc"), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
    end
    ...
    context "given a relationship" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new("abc"), MockRelationship, School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new("abc"), School::BinaryPattern(MockRelationship, String, String), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
    end
    ...
    context "given a relationship" do
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new("abc"), School::Lit.new("xyz"), MockRelationship).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
      ...
      it "asserts a fact when the action is called" do
        expect{subject.assert(School::Lit.new("abc"), School::Lit.new("xyz"), School::BinaryPattern(MockRelationship, String, String)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(MockRelationship.new("abc", "xyz"))
      end
    end
  end
  ...
  describe "#retract" do
    ...
    context "given a fact" do
      before_each { facts.add(MockFact.new) }
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(MockFact).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::NullaryPattern(MockFact)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
    ...
    context "given a property" do
      before_each { facts.add(MockProperty.new(123)) }
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(MockProperty, School::Lit.new(123)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::UnaryPattern(MockProperty, Int32), School::Lit.new(123)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
    ...
    context "given a property" do
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new(123), MockProperty).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new(123), School::UnaryPattern(MockProperty, Int32)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
    ...
    context "given a relationship" do
      before_each { facts.add(MockRelationship.new("abc", "xyz")) }
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(MockRelationship, School::Lit.new("abc"), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::BinaryPattern(MockRelationship, String, String), School::Lit.new("abc"), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
    ...
    context "given a relationship" do
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new("abc"), MockRelationship, School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new("abc"), School::BinaryPattern(MockRelationship, String, String), School::Lit.new("xyz")).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
    ...
    context "given a relationship" do
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new("abc"), School::Lit.new("xyz"), MockRelationship).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
      ...
      it "retracts a fact when the action is called" do
        expect{subject.retract(School::Lit.new("abc"), School::Lit.new("xyz"), School::BinaryPattern(MockRelationship, String, String)).build.actions.first.call(rule, context)}.to change{facts.first?}.to(nil)
      end
    end
  end
